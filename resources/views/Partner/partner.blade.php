				  ...
				  <div class="d-inline-block align-items-center">
					  <nav>
						  <ol class="breadcrumb">
							  ...
							  <li class="breadcrumb-item active" aria-current="page">Partner View</li>
						  </ol>
					  </nav>
				  </div>
			  </div>
			...
			<div class="col-12">
			  <div class="box">
				  <div class="box-header">
					  <h4 class="box-title">Edit/View/Delete <strong>Partners</strong></h4>	
					  <h6 class="subtitle">View USSD Partners</h6>
				  </div>
					  ...
					  <tbody>
						@foreach ($partners as $partner)
						  ...
						  <input type="hidden" class="deletepartner_class editpartner_class" value="{{$partner->id}}">
							  <td class="partner_class">{{$partner->Company}}</td>
